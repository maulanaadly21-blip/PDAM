...
const Pagination = ({ count, perPage, currentPage, id, colorActive, colorPage, optionPerPage }: PropsPagination) => {
    ...
    const stringPagination = (): ReactElement => {
        ...
        return (
            <small className="italic text-sm text-white">
    ...
    const optionPage = (): ReactElement => {
        return (
            <>
                <small className="italic text-white">Show</small>
                <select value={perPage} className="mx-1 p-1 border text-white bg-gray-700" id={`optionPerPageOfPaginate`}
                ...
                <small className="italic text-white"> / page</small>
            </>
