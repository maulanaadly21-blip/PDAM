            ...
            <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Tambah Service">
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input value={name} onChange={e=>setName(e.target.value)} type="text" className="mt-1 block w-full border border-gray-300 rounded-md p-2 text-black" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Min Usage
                        </label>
                        <input value={minUsage} onChange={e=>setMinUsage(Number(e.target.value))} type="number" className="mt-1 block w-full border border-gray-300 rounded-md p-2 text-black" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Max Usage
                        </label>
                        <input value={maxUsage} onChange={e=>setMaxUsage(Number(e.target.value))} type="number" className="mt-1 block w-full border border-gray-300 rounded-md p-2 text-black" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Price
                        </label>
                        <input value={price} onChange={e=>setPrice(Number(e.target.value))} type="number" className="mt-1 block w-full border border-gray-300 rounded-md p-2 text-black" />
                    </div>
